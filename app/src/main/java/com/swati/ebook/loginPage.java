...
//------------------------------------------------------------------------------------------
    ...
    public void regUser2(){
        ...
        String myUrl = "http://192.168.14.68/Dbconnection/login.php?Email="+ EmailHolder + "&Password=" + PasswordHolder;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, myUrl,
                ServerResponse -> {
                    if (ServerResponse.equals("1")){
                        ...
                        String path = "http://192.168.14.68/Dbconnection/retrieve.php?Email=" + EmailHolder;
